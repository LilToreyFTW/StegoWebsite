...
/**
 * Better Auth v1.5.6 Sign Up Component
 * Alternative sign-up option that runs alongside Clerk
 */

import { useState } from "react";
import { signUp } from "@/components/better-auth-provider";
import { Mail, Lock, User, AlertCircle, CheckCircle } from "lucide-react";

interface BetterAuthSignUpProps {
  onSuccess?: () => void;
  onSwitchToClerk?: () => void;
}

export function BetterAuthSignUp({ onSuccess, onSwitchToClerk }: BetterAuthSignUpProps) {
  ...
  return (
    <div className="w-full max-w-md mx-auto p-6 rounded-lg border border-border bg-card">
      <div className="mb-6">
        <h3 className="text-lg font-semibold mb-2">Sign up with Better Auth</h3>
